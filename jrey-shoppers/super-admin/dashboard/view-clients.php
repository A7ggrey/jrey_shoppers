...
<head>
  ...
  <title>Jrey Shoppers | Customer Details</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Jrey Shoppers Customer Details</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                        ...
                        $selectclientsquery = "SELECT * FROM users";
                        ...
                        if (mysqli_num_rows($selectclientsresults) > 0) {
                          ...
                          while ($clientsrows = mysqli_fetch_assoc($selectclientsresults)) {
                            ...
                            $statususer = $clientsrows['userstatus'];
                            ...
                            <tr>
                              ...
                              <td><?php echo $clientsrows['userphone'];?></td>
                              <td><?php echo $clientsrows['userterms'];?></td>
                              <td><?php echo $displaystats;?></td>
