    ...
    if (isset($_POST['admin-login'])) {
        ...
        if (mysqli_num_rows($selectuserresult) > 0) {
            ...
            while ($userselected = mysqli_fetch_assoc($selectuserresult)) {
                ...
                $admid = $userselected['userid'];
                $admemail = $userselected['useremail'];
                $admpass = $userselected['userpassword'];
                $admstatus = $userselected['userstatus'];
            }
            ...
            if ($admstatus == '0') {
                ...
                $insertqueryuserlogs = "INSERT INTO adminlogs(logname, logstatus, logdate, logtime, userid) VALUES('$logn', '$logst', '$logd', '$logt', '$uid')";
                $insertresultuserlogs = mysqli_query($database, $insertqueryuserlogs);
                    ...
                    $insertqueryuserlogs2 = "INSERT INTO adminlogs(logname, logstatus, logdate, logtime, userid) VALUES('$logn', '$logsta', '$logd', '$logt', '$uid')";
