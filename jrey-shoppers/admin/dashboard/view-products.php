                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                        ...
                        $selectitemquery = "SELECT items.*, superadmin.superadminfname, superadmin.superadminlname, superadmin.superadminemail FROM items INNER JOIN superadmin ON superadmin.superadminid = items.adminid";
                        ...
                        if (mysqli_num_rows($selectitemresults) > 0) {
                          ...
                          while ($itemsrows = mysqli_fetch_assoc($selectitemresults)) {
                            ...
                            <tr>
                              ...
                              <td>
                                <?php echo $itemsrows['itemname'];?>
                              </td>
                              <td><?php echo $itemsrows['itemquantity'];?></td>
                              <td><?php echo $itemsrows['itemprice'];?></td>
                              <td><?php echo $itemsrows['itemdate'];?></td>
                              <td>
