  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Super Adminstrator Details</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active">Super Adminstrator</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Jrey Shoppers Super Adminstrator Details</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        if (mysqli_num_rows($selectsuadminresults) > 0) {
                          ...
                          while ($suadminsrows = mysqli_fetch_assoc($selectsuadminresults)) {
                            ...
                            <tr>
                              ...
                              <td><?php echo $suadminsrows['superadminoffice'];?></td>
