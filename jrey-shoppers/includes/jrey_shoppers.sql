...
INSERT INTO `admin` (`adminid`, `adminfname`, `adminlname`, `adminoname`, `admingender`, `admindob`, `adminemail`, `adminphone`, `adminidno`, `adminoffice`, `adminstatus`, `adminterms`, `adminpassword`, `adminphoto`, `regby`, `regdate`) VALUES
(1, 'Aggrey', 'Kiprop', 'James', 'Male', '1998-01-07', 'aggreyjames92@gmail.com', '0', 0, 0, 1, '0', '$2y$10$010Xv0ZGVOFZPjM32cj8rOJcAuPhi68UfmF3O3/4GPhJgMp/uC0dW', '0', 1, '30/12/2022');
...
INSERT INTO `adminlogs` (`logid`, `logname`, `logstatus`, `logdate`, `logtime`, `userid`) VALUES
(50, 'Admin Login', 'Successful', '30/12/2022', '05:44:44pm', 1),
(51, 'Admin Logout', 'Logout Successful', '30/12/2022', '05:45:10pm', 1);
...
CREATE TABLE `completeorders` (
  `completeid` int(50) NOT NULL,
  `completeamount` varchar(20) NOT NULL,
  `paypoints` decimal(20,0) NOT NULL,
  `paymode` varchar(100) NOT NULL,
  `deliveryfee` varchar(20) NOT NULL,
  `corderstatus` int(20) NOT NULL,
  `cdeliverystatus` int(20) NOT NULL,
  `userid` int(20) NOT NULL,
  `adminid` int(20) NOT NULL,
  `paystatus` int(20) NOT NULL,
  `expecteddate` varchar(20) NOT NULL,
  `corderquantity` varchar(20) NOT NULL,
  `corderdate` varchar(20) NOT NULL,
  `cordertime` varchar(20) NOT NULL,
...
--
-- Table structure for table `deliveryperlogs`
--

CREATE TABLE `deliveryperlogs` (
  `logid` int(20) NOT NULL,
  `logname` varchar(50) NOT NULL,
  `logstatus` varchar(50) NOT NULL,
  `logdate` varchar(20) NOT NULL,
...
--
-- Dumping data for table `deliveryperlogs`
--

INSERT INTO `deliveryperlogs` (`logid`, `logname`, `logstatus`, `logdate`, `logtime`, `userid`) VALUES
...
(36, 'User Login', 'Successful', '29/12/2022', '02:25:06pm', 2),
(37, 'User Logout', 'Logout Successful', '30/12/2022', '08:07:59am', 2),
(38, 'User Login', 'Successful', '30/12/2022', '08:08:17am', 2),
(39, 'User Logout', 'Logout Successful', '30/12/2022', '08:10:02am', 2),
(40, 'User Login', 'Successful', '30/12/2022', '08:10:19am', 2);
...
CREATE TABLE `orders` (
  ...
  `itemid` int(20) NOT NULL,
  `orderedquantity` varchar(20) NOT NULL,
  `userid` int(20) NOT NULL,
  `orderstatus` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `superadminlogs`
--
...
--
-- Dumping data for table `superadminlogs`
--

INSERT INTO `superadminlogs` (`logid`, `logname`, `logstatus`, `logdate`, `logtime`, `userid`) VALUES
(6, 'User Login', 'Unsuccessful', '27/11/2022', '08:48:24pm', 2),
(7, 'User Login', 'Unsuccessful', '27/11/2022', '08:49:51pm', 2),
(8, 'User Login', 'Successful', '27/11/2022', '08:50:03pm', 2),
(10, 'User Login', 'Successful', '27/11/2022', '08:57:29pm', 2),
...
--
-- Indexes for table `deliveryperlogs`
--
ALTER TABLE `deliveryperlogs`
  ADD PRIMARY KEY (`logid`);
...
--
-- Indexes for table `superadminlogs`
--
ALTER TABLE `superadminlogs`
  ADD PRIMARY KEY (`logid`);
...
--
ALTER TABLE `adminlogs`
  MODIFY `logid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `completeorders`
  MODIFY `completeid` int(50) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `deliveryperlogs`
--
ALTER TABLE `deliveryperlogs`
  MODIFY `logid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
-- AUTO_INCREMENT for table `superadminlogs`
--
ALTER TABLE `superadminlogs`
  MODIFY `logid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
